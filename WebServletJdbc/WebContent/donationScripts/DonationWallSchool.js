$(function() {
	...
	$("ul.gallery > li").click(function(event) {
		...
		if ($target.is("a.ui-icon-document")) {
			documentEvent($item);
		} else if ($target.is("a.ui-icon-comment")) {
			commentEvent($target);
		}
		return false;
	});
