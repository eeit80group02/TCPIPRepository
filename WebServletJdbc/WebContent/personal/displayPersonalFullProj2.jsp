...
<div class="row" id="mainboard">
	<div class="col l8 offset-l2 indigo lighten-5">
		<h1 class="row center-align card-panel">瀏覽完整計畫</h1>
		<div class="row" style="border:2px solid blue;">
			<div class="col l4　center-align" style="border:2px solid red;">
			完整計畫編號
			</div>
			<div class="col l8 center-align" style="border:2px solid yellow;">
			完整計畫主題
			</div>
		</div>
	</div>
