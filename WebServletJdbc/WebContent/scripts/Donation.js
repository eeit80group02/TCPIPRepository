...
//		alert(donationId);
	...
	function viewLargerImage($link) {
		...
		var array1=$link.attr("id");
		
		var array2=array1.match(/[^\+]+/g);
		alert(array2[4]);
		supplyName = array2[4];
		demandNumber = array2[7];
//		size = array2[8];
		donationStatus = array2[3];
		schoolName = array2[2];
		demandTime = array2[11];
		expireTime = array2[12];
		demandContent = array2[9];
		remark = array2[13];
		
		
		var img = $(
				'<center><table><tr><td rowspan="10"><img alt=' + supplyName + ' title=' + supplyName + ' src=' + imgLet + ' width="300"></td><td style="text-align: right; width: 150px;">物資名稱：</td><td style="width: 350px; word-break: break-all;">' + supplyName + '</td></tr><tr><td style="text-align: right; width: 150px;">需求數量：</td><td style="width: 350px;">' + demandNumber + '</td></tr><tr><td style="text-align: right; width: 150px;">尺寸規格：</td><td style="width: 350px;">' + size + '</td></tr><tr><td style="text-align: right; width: 150px;">物資狀態：</td><td style="width: 350px;">' + donationStatus + '</td></tr><tr><td style="text-align: right; width: 150px;">需求單位：</td><td style="width: 350px;">' + schoolName
						+ '</td></tr><tr><td style="text-align: right; width: 150px;">需求單位地址：</td><td style="width: 350px;">屏東縣鹽埔鄉鹽南村勝利路30號</td></tr><tr><td style="text-align: right; width: 150px;">募集起始時間：</td><td style="width: 350px;">' + demandTime + '</td></tr><tr><td style="text-align: right; width: 150px;">募集結束時間：</td><td style="width: 350px;">' + expireTime + '</td></tr><tr><td style="text-align: right; width: 150px;">募集原因：</td><td style="width: 350px; word-break: break-all;">' + demandContent + '</td></tr><tfoot><tr><td style="text-align: center; vertical-align: text-top; padding-top: 20px;"><a href=' + link + ' target="_blank"><img alt="問與答" title="問與答" src="../images/QA.png" width="80px" border="2px solid black"></a> <br> <a href=' + toCart
						+ ' target="_blank"><img alt="查看同學校的其他物資" title="查看同學校的其他物資" src="../images/search.png" width="35px" style="float: left;"></a> <a href=' + toCart + ' target="_blank"><img alt="加入捐獻背包" title="加入捐獻背包" src="../images/buy.png" width="35px" style="float: right;"></a></td><td style="text-align: right; width: 150px; vertical-align: top; padding-top: 10px;">備註：</td><td style="border: 1px solid black; padding: 5px; word-break: break-all;"><div style="width: 350px; height: 120px; overflow: auto;">' + remark + '</div></td></tr></tfoot></table></center>').appendTo("body");
		setTimeout(function() {
			img.dialog({
				title : title,
				width : 850,
