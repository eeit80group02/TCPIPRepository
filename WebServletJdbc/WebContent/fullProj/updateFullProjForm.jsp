			...
			<form class="card-panel hoverable" action="<c:url value="/primaryProj.do" />" method="post" enctype="multipart/form-data" style="padding:2.5em;background-color:#FFFCEC;" id="primaryform">
				...
				<div class="row">
						...
						<div class="row orange accent-3">
							...
							<div class="row">
								<div class="col l8">
									<div class="forinput">計畫編號:${fullProj.fullProjId}</div>
								</div>
							</div>
							<!-- 會員編號 -->
							<div class="row">
								<div class="col l8">
									<div class="forinput">會員編號:${fullProj.memberId}</div>
								</div>
							</div>						
							<!-- 學校編號 -->
							<div class="row">
								<div class="col l8">
									<div class="forinput">學校編號:${fullProj.schoolId}</div>
								</div>
							</div>						
						</div>				
...
<%-- 						<input type="text" name="title" value="${param.title}" /><span class="error">${error.title}</span>--%>
						<div class="row">
							<div class="col l8">
								...
								<input id="title" type="text" name="title" required value="${fullProj.title}" style="font-size:1.2em;color:black;font-weight:600;">
							</div>
							<div class="col l4">	
...
<%-- 						<input type="text" value="${param.location}"  name="location"><span class="error">${error.location}</span> --%>
						<div class="row">
							<div class="col l4">
									...
									<input class="center-align forvalue" id="location" type="text" required value="${fullProj.location}" name="location" style="font-size:1.2em;color:black;font-weight:600;">	
							</div>
							<div class="col l4">	
...
<%-- 						<input type="date" value="${param.startTime}" name="startTime"> --%>
						...
						<div class="input-field row">
							<div class="col l4">
								...
								<input type="date" name="activityStartTime" id="activityStartTime" value="${fullProj.activityStartTime}">
							</div>	
							<div class="col l2">
							...
							<div class="col l4">
								...
								<input type="date" name="activityEndTime" id="activityEndTime" value="${fullProj.activityEndTime}">
							</div>	
							<div class="col l2">
...
<%-- 						<input type="number" value="${param.demandNum}" name="demandNum" /><span class="error"> --%>
						<div class="row">
							<div class="col l8">
								...
								<input id="estMember" type="number" name="estMember" required value="${fullProj.estMember}" style="font-size:1.2em;color:black;font-weight:600;">
							</div>
							<div class="col l4">	
...
<%-- 						<input type="number" value="${param.budget}" name="budget" /> --%>
						<div class="row">
							<div class="col l8">
								...
								<input id="budget" type="number" name="budget" required value="${fullProj.budget}" style="font-size:1.2em;color:black;font-weight:600;">
							</div>
							<div class="col l4">	
...
<%-- 						<textarea rows="10" cols="100" name="projAbstract">${param.projAbstract}</textarea> --%>
						<div class="row">
							<div class="col l8">
								...
								<input id="orgArchitecture" name="orgArchitecture" type="text"  value="${fullProj.orgArchitecture}" style="font-size:1.2em;color:black;font-weight:600;">
							</div>
							<div class="col l4">	
...
<%-- 						<textarea rows="10" cols="100" name="projAbstract">${param.projAbstract}</textarea> --%>
						<div class="row">
							<div class="col l8">
								...
								<textarea class="materialize-textarea" id="projAbstract" rows="10" cols="100" name="projAbstract" style="font-size:1.2em;color:black;font-weight:600;">${fullProj.projAbstract}</textarea>
							</div>
							<div class="col l4">	
						...
						<div class="row">
							<div class="col l8">
								...
								<textarea class="ckeditor" id="content" rows="10" cols="100" name="content" style="font-size:1.2em;color:black;font-weight:600;">${fullProj.content}</textarea>
							</div>	
							<div class="col l4">	
