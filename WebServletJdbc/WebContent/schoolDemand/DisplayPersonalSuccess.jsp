...
<body class="deep-orange lighten-5">
	...
	<div class="row grey darken-4 valign-wrapper" id="pagetitle">
		<h1 class="valign center-align white-text"
			style="font-family: 微軟正黑體; margin: 0 auto; font-size: 5em;">洽談成功</h1>
	</div>
	...
	<main>
		<div class="row" id="mainboard">
			...
			<div class="col l8 offset-l2 indigo lighten-5">
				<div class="row center-align card-panel red-text" style="font-size:4em;">洽談成功需求計畫</div>
						...
						<tbody>
							<c:forEach var="demand" items="${list}" varStatus="varStatus">
								<tr>
									...
									<td class="red-text" style="font-size:1.6em;font-weight:600">洽談成功</td>
									<td>
