...
public class DonationOrderBean implements Serializable
{
	...
	{
		return "DonationOrderBean [donationOrderId=" + donationOrderId + ", memberId=" + memberId + ", name=" + name + ", address=" + address + ", phone=" + phone + ", cellPhone=" + cellPhone + ", email=" + email + ", pickTime=" + pickTime
				+ ", donationOederDate=" + donationOederDate + ", dealId=" + dealId + "]";
	}
