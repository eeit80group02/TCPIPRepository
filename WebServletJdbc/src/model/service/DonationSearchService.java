...
//						dbdList.add(dbd);
	...
	public List<DonationBeanDuplicate> manageSchoolByStatus(String supplyStatus, int schoolId){
		DonationBeanDuplicate dbd;
		DonationDAO donationDAO = new DonationDAOJdbc();
...
//			}
	...
	public List<DonationBeanDuplicate> manageSchoolByOriginalDemandNumber(int schoolId){
		DonationBeanDuplicate dbd;
		DonationDAOJdbc donationDAO = new DonationDAOJdbc();
		List<DonationBean> odbList = donationDAO.getAllByODNumber();
...
//			}
	...
	public List<DonationBeanDuplicate> manageSchoolByExpiretime(int schoolId){
		DonationBeanDuplicate dbd;
		DonationDAOJdbc donationDAO = new DonationDAOJdbc();
		List<DonationBean> odbList = donationDAO.getAllByExpiretime();
...
//			}
	...
	public List<DonationBeanDuplicate> manageSchoolByDemandtime(int schoolId){
		DonationBeanDuplicate dbd;
		DonationDAOJdbc donationDAO = new DonationDAOJdbc();
		List<DonationBean> odbList = donationDAO.getAllByDemandtime();
