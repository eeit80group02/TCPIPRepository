...
public class DonationBillBean implements Serializable
{
	...
	// add 
	private List<DonationBeanDuplicate> dbdList;
	private String dealId;
	
	public List<DonationBeanDuplicate> getDbdList() {
		return dbdList;
	}

	public void setDbdList(List<DonationBeanDuplicate> dbdList) {
		this.dbdList = dbdList;
	}
	...
	public String toString() {
		return "DonationBillBean [schoolId=" + schoolId + ", name=" + name + ", phone=" + phone + ", addressDistrict="
				+ addressDistrict + ", addressComplete=" + addressComplete + ", url=" + url + ", frontCoverName="
				+ frontCoverName + ", frontCover=" + Arrays.toString(frontCover) + ", frontCoverLength="
				+ frontCoverLength + ", aboutMe=" + aboutMe + ", managerEmail=" + managerEmail + ", projectManager="
				+ projectManager + ", accountContact=" + accountContact + ", password=" + Arrays.toString(password)
				+ ", accountStatus=" + accountStatus + ", dbdList=" + dbdList + ", base64String=" + base64String + "]";
	}
}
