...
public class SchoolDemandBean {
	...
	public String toString() {
		return "SchoolDemandBean [schoolDemandId=" + schoolDemandId + ", schoolId=" + schoolId + ", participant="
				+ participant + ", activityTopicPicture=" + activityTopicPicture + ", activityLocation="
				+ activityLocation + ", activitySuitable=" + activitySuitable + ", activityHost=" + activityHost
				+ ", activityContact=" + activityContact + ", createDate=" + createDate + ", content=" + content + "]";
	}
	...
	public String getActivityTopicPicture() {
		return activityTopicPicture;
	}

	public void setActivityTopicPicture(String activityTopicPicture) {
		this.activityTopicPicture = activityTopicPicture;
	}
